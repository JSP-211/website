    ...
    <div id="content">
        <p>
            <%
                ...
                projects.add(new Project("Website", "This is the website you are currently viewing, it is my first" +
                ...
                projects.add(new Project("IRCBot", "This is just a side project for me at the moment, it is very basic and the"
